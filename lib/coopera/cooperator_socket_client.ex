defmodule Coopera.CooperatorSocketClient do
  @moduledoc false
  require Logger
  ...
  def handle_connected(transport, state) do
    ...
    GenSocketClient.join(transport, "cooperator")
    {:ok, state}
  end
  ...
  def handle_info(:ping_server, transport, state) do
    Logger.info("coopeartor sending ping ##{state.ping_ref}")
    GenSocketClient.push(transport, "cooperator", "ping", %{ping_ref: state.ping_ref})
